...
export type Database = {
  ...
  public: {
    Tables: {
      buffet_plans: {
        Row: {
          ...
          id: string
          included_categories: Json | null
          name: string
          name_zh: string | null
          price_per_pax: number
          service_charge_exempt: boolean | null
      ...
      orders: {
        Row: {
          buffet_adults: number | null
          buffet_children: number | null
          buffet_ended_at: string | null
          buffet_plan_id: string | null
          buffet_started_at: string | null
          buffet_subtotal: number | null
          created_at: string
        ...
        Relationships: [
          {
            foreignKeyName: "orders_buffet_plan_id_fkey"
            columns: ["buffet_plan_id"]
            isOneToOne: false
            referencedRelation: "buffet_plans"
            referencedColumns: ["id"]
          },
          {
    ...
    Enums: {
      ...
      service_mode: "dine-in" | "takeaway" | "delivery" | "pickup" | "buffet"
